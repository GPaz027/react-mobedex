...
const App = () => {
  ...
  }, [monsters, searchField]); // El filtrado ahora se ejecuta sólo cuando hay actualizaciones en monsters o searchField, lo que evita que se filtre en caso de haber otra actualización de estado si existiese.
